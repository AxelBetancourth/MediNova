    ...
    public partial class Calendario : Form
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (var cita in citasDelDia)
                    {
                        ...
                        // Evento click para editar la cita (capturar citaId en closure)
                        int citaIdLocal = cita.CitaId;
                        panelCita.Click += (s, e) => AbrirEditarCita(citaIdLocal);
                        foreach (Control ctrl in panelCita.Controls)
                        {
                            ctrl.Click += (s, e) => AbrirEditarCita(citaIdLocal);
                        }
        ...
        private void AbrirEditarCita(int citaId)
        {
            ...
            if (panelMain != null && panelMain.Name == "PanelMain")
            {
                ...
                agendarForm.CargarCita(citaId); // Método que crearemos luego
